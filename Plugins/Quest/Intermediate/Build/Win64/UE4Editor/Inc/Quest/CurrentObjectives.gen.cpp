...
#include "Quest/Public/CurrentObjectives.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCurrentObjectives_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCurrentObjectives_SetCurrentObjectives, "SetCurrentObjectives" }, // 1577715331
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCurrentObjectives_Statics::NewProp_ObjectivesList = { "ObjectivesList", nullptr, (EPropertyFlags)0x0010000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCurrentObjectives, ObjectivesList), Z_Construct_UClass_UVerticalBox_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCurrentObjectives_Statics::NewProp_ObjectivesList_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCurrentObjectives_Statics::NewProp_ObjectivesList_MetaData)) };
	...
	IMPLEMENT_CLASS(UCurrentObjectives, 2706957418);
	template<> QUEST_API UClass* StaticClass<UCurrentObjectives>()
	{
		return UCurrentObjectives::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UCurrentObjectives(Z_Construct_UClass_UCurrentObjectives, &UCurrentObjectives::StaticClass, TEXT("/Script/Quest"), TEXT("UCurrentObjectives"), false, nullptr, nullptr, nullptr);
