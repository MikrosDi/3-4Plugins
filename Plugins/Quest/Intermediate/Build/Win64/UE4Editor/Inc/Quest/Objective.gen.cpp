...
#include "Quest/Public/Objective.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	QUEST_API UEnum* Z_Construct_UEnum_Quest_EObjectiveType();
	UPackage* Z_Construct_UPackage__Script_Quest();
	QUEST_API UClass* Z_Construct_UClass_UObjective_NoRegister();
	QUEST_API UClass* Z_Construct_UClass_UObjective();
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject();
	QUEST_API UClass* Z_Construct_UClass_ULocationObjective_NoRegister();
	QUEST_API UClass* Z_Construct_UClass_ULocationObjective();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	QUEST_API UClass* Z_Construct_UClass_UInteractionObjective_NoRegister();
	QUEST_API UClass* Z_Construct_UClass_UInteractionObjective();
// End Cross Module References
	static UEnum* EObjectiveType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Quest_EObjectiveType, Z_Construct_UPackage__Script_Quest(), TEXT("EObjectiveType"));
		}
		return Singleton;
	}
	template<> QUEST_API UEnum* StaticEnum<EObjectiveType>()
	{
		return EObjectiveType_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EObjectiveType(EObjectiveType_StaticEnum, TEXT("/Script/Quest"), TEXT("EObjectiveType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Quest_EObjectiveType_Hash() { return 1161398029U; }
	UEnum* Z_Construct_UEnum_Quest_EObjectiveType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Quest();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EObjectiveType"), 0, Get_Z_Construct_UEnum_Quest_EObjectiveType_Hash(), false);
#else
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UObjective_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UObjective, Type), Z_Construct_UEnum_Quest_EObjectiveType, METADATA_PARAMS(Z_Construct_UClass_UObjective_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UObjective_Statics::NewProp_Type_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UObjective, 3632652400);
	template<> QUEST_API UClass* StaticClass<UObjective>()
	{
		return UObjective::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UObjective(Z_Construct_UClass_UObjective, &UObjective::StaticClass, TEXT("/Script/Quest"), TEXT("UObjective"), false, nullptr, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(ULocationObjective, 190589764);
	template<> QUEST_API UClass* StaticClass<ULocationObjective>()
	{
		return ULocationObjective::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ULocationObjective(Z_Construct_UClass_ULocationObjective, &ULocationObjective::StaticClass, TEXT("/Script/Quest"), TEXT("ULocationObjective"), false, nullptr, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(UInteractionObjective, 113572651);
	template<> QUEST_API UClass* StaticClass<UInteractionObjective>()
	{
		return UInteractionObjective::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UInteractionObjective(Z_Construct_UClass_UInteractionObjective, &UInteractionObjective::StaticClass, TEXT("/Script/Quest"), TEXT("UInteractionObjective"), false, nullptr, nullptr, nullptr);
