...
#define UE_PROJECT_NAME MediaPlayerProject
#define UE_TARGET_NAME MediaPlayerProjectEditor
#define UE_MODULE_NAME "Quest"
#define UE_PLUGIN_NAME "Quest"
